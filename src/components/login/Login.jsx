...
function Login() {
  ...
  const [changePassword, setChangePassword] = useState(false); // État pour gérer l'ouverture du menu
  ...
  const toggleMenu = () => {
    setIsOpen(!isOpen); // Bascule l'état d'ouverture du menu
  };
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="#" method="POST" className="space-y-4">
            ...
            <div>
              <Link
                to="/home"
                className="flex py-2 mt-10 w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 -----focus-visible:outline -----focus-visible:outline-2 -----focus-visible:outline-offset-2 -----focus-visible:outline-indigo-600"
              >
