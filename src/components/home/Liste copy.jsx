...
function Liste({ setShowListOption }) {
  ...
  // Fonction pour gérer le clic sur un véhicule
  const handleClick = (vehicle) => {
    ...
    // Appeler fetchVehicleDetails avec les paramètres sous forme de chaîne
      ...
      <div className="p-4 flex flex-col gap-4 mt-4 mb-32">
        {vehicleData &&
          vehicleData.map((vehicle, index) => (
            <div
              key={index}
              onClick={() => handleClick(vehicle)} // Appeler handleClick avec les détails du véhicule
