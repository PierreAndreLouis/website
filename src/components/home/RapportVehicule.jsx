...
function RapportVehicule() {
  ...
  return (
    <div className="mb-56">
      ...
      <Header />
      <SideBar />
      {showRapportPupup && <RapportOptions setshowRapportPupup = {setshowRapportPupup}  />}
      ...
      <div className="mt-20 px-4">
        ...
        <div className="transition-all ">
          ...
          >
            ...
            <FaChevronDown className={`${showActiveVehicule ? "rotate-180": "rotate-0"} transition-all`} />

          </div>
          <div
          onClick={() => {setshowRapportPupup(true)}}
            className={` ${
              showActiveVehicule
                ? "max-h-[100rem] pb-20 overflow-y-auto transition-all"
                : "max-h-[0rem] transition-all"
            } flex   overflow-hidden flex-col gap-4 transition-all `}
          >
            <div className="bg-white">
              <div className={` bg-green-100/40 shadow-md rounded-lg p-3`}>
                <div className="flex items-stretch relative gap-3 md:py-6--">
                  <div className="flex justify-center border-2 md:pt-6 md:pb-8 bg-green-500 border-white shadow-md shadow-green-200 rounded-md p-2 flex-col items-center md:min-w-32">
                    <div className="">
                      <img
            ...
            <div className="bg-white">
              <div className={` bg-green-100/40 shadow-md rounded-lg p-3`}>
                <div className="flex items-stretch relative gap-3 md:py-6--">
                  <div className="flex justify-center border-2 md:pt-6 md:pb-8 bg-green-500 border-white shadow-lg shadow-green-200 rounded-md p-2 flex-col items-center md:min-w-32">
                    <div className="">
                      <img
                        className="min-w-[4.5rem] max-w-[4.5rem] sm:max-w-[6.5rem]"
                        src="/img/home_icon/rapport_active.png"
        ...
        <div className="transition-all">
          ...
          >
            ...
            <FaChevronDown className={`${showParkingVehicule ? "rotate-180": "rotate-0"} transition-all`} />
          </div>
          ...
          >
            <div className="bg-white">
              <div className={` bg-red-100/30 shadow-md rounded-lg p-3`}>
                <div className="flex items-stretch relative gap-3 md:py-6--">
                  <div className="flex justify-center border-2 md:pt-6 md:pb-8 bg-red-700 border-white shadow-md shadow-red-200 rounded-md p-2 flex-col items-center md:min-w-32">
                    <div className="">
                      <img
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <span
                        className={` bg-red-300/30 ml-1  text-red-800 pb-[.2rem] px-2 py-0 text-sm rounded-md `}
                      >
                        En Stationnement
                      </span>
                    </div>
            ...
            <div className="bg-white">
              <div className={` bg-red-100/30 shadow-md rounded-lg p-3`}>
                <div className="flex items-stretch relative gap-3 md:py-6--">
                  <div className="flex justify-center border-2 md:pt-6 md:pb-8 bg-red-700 border-white shadow-lg shadow-red-200 rounded-md p-2 flex-col items-center md:min-w-32">
                    <div className="">
                      <img
                        className="min-w-[4.5rem] max-w-[4.5rem] px-2 sm:max-w-[6.5rem]"
                        src="/img/home_icon/rapport_parking.png"
        ...
        <div className="transition-all">
          ...
          >
            ...
            <FaChevronDown className={`${showInactiveVehicule ? "rotate-180": "rotate-0"} transition-all`} />
          </div>
            ...
            >
              <div className="bg-white">
                <div className={` bg-purple-100/50 shadow-md rounded-lg p-3`}>
                  <div className="flex items-stretch relative gap-3 md:py-6--">
                    <div className="flex justify-center border-2 md:pt-6 md:pb-8 bg-purple-700 border-white shadow-md shadow-purple-200 rounded-md p-2 flex-col items-center md:min-w-32">
                      <div className="">
                        <img
                          className="min-w-[4.5rem] max-w-[4.5rem] px-2 sm:max-w-[6.5rem]"
              ...
              <div className="bg-white">
                <div className={` bg-purple-100/50 shadow-md rounded-lg p-3`}>
                  <div className="flex items-stretch relative gap-3 md:py-6--">
                    <div className="flex justify-center border-2 md:pt-6 md:pb-8 bg-purple-700 border-white shadow-lg shadow-purple-200 rounded-md p-2 flex-col items-center md:min-w-32">
                      <div className="">
                        <img
                          className="min-w-[4.5rem] max-w-[4.5rem] px-2 sm:max-w-[6.5rem]"
                          src="/img/home_icon/rapport_not_active.png"
