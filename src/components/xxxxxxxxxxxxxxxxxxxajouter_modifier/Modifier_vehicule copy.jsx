...
function Modifier_vehicule({ setModifierVehicule }) {
  const { deleteVehicle, updateVehicle, vehicleData } = useContext(DataContext);
  ...
  const modification_vehicule = () => {
    const deviceID = "11111111111";
    const description = "modification test";
    const equipmentType = "modification test";
    const uniqueID = "modification test";
    const imeiNumber = "modification test";
    const vehicleID = "modification test";
    const licensePlate = "modification test";
    const simPhoneNumber = "modification test";
    const displayName = "modification test";
  ...
  return (
    <div>
      ...
      <div
        id=""
        className={" flex w-full justify-center mt-16 md:mt-20 h-full"}
      >
          ...
          <div className="bg-white max-w-[30rem] w-full  shadow-lg overflow-auto">
            <div className="flex justify-center items-center w-full py-10">
              ...
              <h3 className="text-center font-semibold text-gray-600 text-xl">
                Modifier Appareilllll
              </h3>
            </div>

            <button
              onClick={() => {
                deleteVehicle("1731100249");
              }}
            >
              Test delete vehicule
            </button>
