...
const MapComponent = ({ vehicles }) => {
  ...
  return (
    <div className="relative">
      <div className="flex items-center gap-4 border px-2 py-1 cursor-pointer bg-orange-50 absolute left-[1rem] top-[3.75rem] max-w-[13rem] rounded-md z-[1200]">
...
const Groupe_vehicule_location = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed bg-white top-12  left-0 right-0 z-[1200] flex flex-col gap-4 p-4">
        <h3
          onClick={() => {
            showAllVehicles();
        ...
        <h2
          ...
          id="vehicule_actuel"
          className="flex justify-between items-center border py-2 px-5 rounded-md w-full max-w-[30rem] mx-auto cursor-pointer bg-orange-50"
        >
          {selectedVehicle
            ? vehicleData?.find(
                (vehicle) => vehicle.deviceID === selectedVehicle
