...
function Groupe_vehicule_location() {
  return (
    <div>Groupe_vehicule_location</div>
  )
}
...
//           alert("Impossible de récupérer la position actuelle. Veuillez vérifier les permissions.");
//         }
//       );
//     } else {
...
//   const {  vehicleDetails, isLoading, fetchVehicleDetails } = useContext(DataContext); // fetchVehicleDetails importée du contexte

//   const vehicleData = [
//     {
//       description: "Véhicule 1",
//       lastValidLatitude: vehicleDetails.latitude,
//       lastValidLongitude: vehicleDetails.longitude,
//     },
