...
const DataContextProvider = ({ children }) => {
  ...
  const fetchVehicleDetails = async (device, datefin) => {
    if (!userData) return;
    ...
    const xmlData = `
      <GTSRequest command="eventdata">
        ...
        <EventData>
          ...
          <TimeFrom timezone="GMT">2011-01-07 10:29:34</TimeFrom>
          <TimeTo timezone="GMT">${datefin}</TimeTo>
  ...
  useEffect(() => {
    if (userData) {
      fetchVehicleData();
      fetchVehicleDetails('863844052656169', '2024-10-26 23:59:59');
    }
  }, [userData]);
